...
| Tool | Notes |
|------|-------|
| `read_file` | Supports text, images (jpg/png/gif/webp), and PDFs — binary content passed natively, not transcribed. Text files >50k bytes are blocked with a hint to use `bash` (grep) instead |
