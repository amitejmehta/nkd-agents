...
→ **[CLI docs](docs/cli.md)** — everything you need to use `nkd`: keybindings, modes, skills, subagents, auto-compact, full config reference. Start here.
...
→ **[Decisions doc](docs/decisions.md)** — what got built, what got deprecated, what got rejected, and why. The most honest description of this project's actual philosophy.
